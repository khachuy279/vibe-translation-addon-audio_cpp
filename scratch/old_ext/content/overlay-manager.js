...
class OverlayManager {
  constructor() {
    ...
    this._checkParentInterval = null;
  }
  ...
  init(video = null) {
    ...
    // Keep host properly attached to parent if page modifies DOM
    this._checkParentInterval = setInterval(() => {
  ...
  destroy() {
    ...
    if (this._checkParentInterval) {
      clearInterval(this._checkParentInterval);
      this._checkParentInterval = null;
    }
